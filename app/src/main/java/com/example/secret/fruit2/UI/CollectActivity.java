...
import com.example.secret.fruit2.Adapter.CollectAdapter;
...
public class CollectActivity extends AppCompatActivity implements CollectAdapter.CheckBoxChangedListener {
    ...
    //存储收藏数据
    private List<IsSelect<Collection>> collections = new ArrayList<>();
            ...
            public void done(List<Collection> list, BmobException e) {
                if (e == null) {
                    ...
                    for (Collection collection : list) {
                        IsSelect<Collection> isSelect = new IsSelect<>();
                        isSelect.setType(collection);
                        collections.add(isSelect);
                        System.out.println("===type:"+collection.getRecipe().getName());
                    }
    ...
    private void initEvent() {
        ...
        tvSelectAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (IsSelect<Collection> isSelect : collections) {
        ...
        tvCancelAll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                for (IsSelect<Collection> isSelect : adapter.selectedItems) {
